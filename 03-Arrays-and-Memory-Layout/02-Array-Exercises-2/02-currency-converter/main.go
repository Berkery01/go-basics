...
func main() {
	...
	fmt.Printf("%.2f is %.2f EUR.\n", input, ratios[EUR]*input)
	fmt.Printf("%.2f is %.2f GBP.\n", input, ratios[GBP]*input)
	fmt.Printf("%.2f is %.2f JPY.\n", input, ratios[JPY]*input)
